        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-1 space-y-4">
            <Link href="/" className="flex items-center space-x-2">
              ...
              <span className="inline-block font-bold text-2xl font-headline text-background">
                GasyGo
              </span>
            </Link>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              <li className="flex items-center gap-2">
                ...
                <a href="tel:+254704095021" className="hover:underline">
                  +254704095021
                </a>
              </li>
              <li className="flex items-center gap-2">
                ...
                <a href="https://wa.me/254704095021" target="_blank" rel="noopener noreferrer" className="hover:underline">
                  +254704095021
                </a>
              </li>
              <li className="flex items-center gap-2">
                <Mail className="h-5 w-5 text-primary" />
                <a href="mailto:mosesissa810@gmail.com" className="hover:underline">
